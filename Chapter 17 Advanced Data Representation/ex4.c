/* C Primer Plus. Programming Exercise 17.4
...
int main(void)
{
    ...
    long served1 = 0; // served line 1 during the simulation
    long served2 = 0; // served line 2 during the simulation
    ...
    puts("Case Study: Sigmund Lander's Advice Double Booth");
    ...
    if (customers > 0)
    {
        ...
        printf("customers served in line 1: %ld\n", served1);
        printf("customers served in line 2: %ld\n", served2);
        printf("turnaways: %ld\n", turnaways);
        printf("average queue size: %.2f\n",
               (double) (sum_line1 + sum_line2) / (2 * cyclelimit));
        printf("average wait time: %.2f minutes\n",
               ((double) line_wait1/served1 + (double) line_wait2/served2) / 2);
    }
    else
        puts("No customers!");
    EmptyTheQueue(&line1);
